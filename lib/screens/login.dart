...
class _LoginPageState extends State<LoginPage> {
  ...
  void login() async {
    ...
    if (response.statusCode == 200) {
      ...
      print("bksadkjsa $responseData");

       final id = responseData['id'] ;
       final adsoyad = responseData['adsoyad'];
      ...
      if (id != null) {
        ...
        print('id bilgiisi $id');
        print('ad soyad bilgiisi $adsoyad');

        Navigator.push(context, MaterialPageRoute(builder: (context) => HomePage(email: email.toString(), password: password.toString(), id: id, adsoyad: adsoyad.toString(),),),);
      }
      else{
        print("HATA VAR");
      }
